...
public class Utilidades {
    ...
    public static final String TC_ACCALERTA = "tc_accalerta";
    ...
    private ContentValues genera_control(int id_visxapli, String fecha, int idvisita, String hora_ini, String hora_fin, String obs, int chkprev, int chkcorr, String firma, int imgdisp, int chkfoto, int chkhora, int accalerta, String accprev, String acccorr, String horri, int numest, int numconsi, String autorizado, String idauto, int regestacion) {
        ContentValues valores = new ContentValues();
        ...
        valores.put(TC_ACCALERTA, accalerta);
    ...
    private ContentValues genera_control2(ControlServicio cs){
        ...
        valores.put(TC_ACCALERTA, cs.getAccalerta());
    ...
    public void insertar_control(ControlServicio cs){
        db.insert(TABLA_CONTROL,null, genera_control(cs.getIdvisxapli(), cs.getFecha(), cs.getIdvisita(), cs.getHora_ini(), cs.getHora_fin(), cs.getObs(), cs.getChkprev(), cs.getChkcorr(), cs.getFirma(), cs.getImgdisp(), cs.getChkfoto(), cs.getChkhora(), cs.getAccalerta(), cs.getAccprev(), cs.getAcccorr(), cs.getHorri(), cs.getNumest(), cs.getNumconsi(), cs.getAutorizado(), cs.getIdauto(), cs.getRegestacion()));
    }
    ...
    public Cursor CargarDatosControl(int id_visxapli) {
        String[] columnas = new String[]{TC_IDVISXAPLI, TC_FECHA, TC_IDVIS, TC_HINI, TC_HFIN, TC_OBS, TC_CHKPREV, TC_CHKCORR, TC_FIRMA, TC_IMGDISP, TC_CHKFOTO, TC_CHKHORA, TC_ACCALERTA, TC_ACCPREV, TC_ACCCORR, TC_HORRI, TC_NUMEST, TC_NUMCONSI, TC_AUTORIZADO, TC_IDAUTO, TC_REGESTACION};
        String[] parametros = {""+id_visxapli};
    ...
    public void Actualiza_control(int id_visxapli, String fecha, int idvisita, String hora_ini, String hora_fin, String obs, int chkprev, int chkcorr, String firma, int imgdisp, int chkfoto, int chkhora, int accalerta, String accprev, String acccorr, String horri, int numest, int numconsi, String autorizado, String idauto, int regestacion){
        ContentValues valores = new ContentValues();
        valores.put(TC_FECHA, fecha);
        valores.put(TC_IDVIS, idvisita);
        valores.put(TC_HINI, hora_ini);
