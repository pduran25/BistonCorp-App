...
public class BS_LoginAplicador extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bs__login_aplicador);
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(BS_LoginAplicador.this,
        ...
        txt_info = (TextView) findViewById(R.id.txt_nuevoaplicador);

        prgDialog = new ProgressDialog(this);
        prgDialog.setMessage("Buscando Aplicador en BistonCorp Server, Por Favor espere...");
        prgDialog.setCancelable(false);

        btn_login = (CardView) findViewById(R.id.btn_iniciosesion);
    ...
    private void volverAtras() {
        ...
        Intent intent = new Intent(BS_LoginAplicador.this, BS_seltipousuario.class);
    ...
    private void CargarWebService(){
        ...
        if(usuario.trim().length() > 0 && contra.trim().length() > 0) {
            prgDialog.show();
            String url = "https://app.bistoncorp.com/php/connect_app/db_getAplicador.php?usuario="+usuario+"&contra="+contra;
    ...
    public void onResponse(JSONObject response) {
        try {
            ...
            usu = new cl_usuario();
            prgDialog.hide();
            if(response.getInt("us_codigo") != 0 && response.getInt("us_estado") == 1){
    ...
    private void abrir_ingreso(){
        ...
        Intent i = new Intent(getApplicationContext(), BS_MenuAplicador.class);
